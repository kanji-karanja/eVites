  ...
  <body>
    ...
    <div id="nav-top">
      ...
      <ul id ="navul">
        ...
        <li style="float: left; width: 15px;height: 15px;margin-top: -30px">
         <a href="#"><img alt="profile image" src="images/logo/eViter.png"></a></li >
          <li><a href="#home" ><i class="fa fa-home" style="margin-right: 5px;"></i>Home</a>
          </li>
          <li><a href="#about">Profile</a></li>
          <li><a href="#contact">Contact</a></li>
          <li><a href="#eVite">Send eVite</a></li>
          <li><a id = "sign" href="#">Sign-up | Sign-in</a></li>
        </ul>
        ...
        <div class = "panel" id="about" >
         ...
         <div class="row" >
          <div class="col-md-12 text-center aboutheader">
            ...
            <h1 class="section-header " style="font-family: CDB;">About Our eVite<span class="underline animated" data-animation="fullWidth"></span></h1>
        ...
        <div class="modal-body">
          ...
          <div class="aa">
            ...
            <form action="" method="post">
              ...
              <button type="submit" name="login" id="log" class="btn btn-success">Log in</button> <button class="btn btn-primary" id="reg">Register</button>    
